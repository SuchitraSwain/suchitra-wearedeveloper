  ...
  return (
    <PresentationSlide className="items-center justify-center">
      <div className="flex min-h-0 flex-1 flex-col items-center justify-center gap-[clamp(0.75rem,2cqw,1.25rem)] px-2">
        <figure className="flex max-h-[min(78vh,820px)] w-full max-w-md flex-col items-center gap-4">
          <div className="relative w-full overflow-hidden rounded-2xl border border-white/10 bg-white shadow-[0_24px_80px_rgba(0,0,0,0.5)]">
            <img
              src={meme.src}
              alt={meme.alt}
              width={460}
              ...
              fetchPriority="high"
              decoding="async"
              className="mx-auto max-h-[min(72vh,760px)] w-full object-contain"
            />
          </div>
          {meme.caption ? (
